...
# -- 格子类型（15种地块 + 8种功能格 = 23种）--
const GRID_TYPES = [
	{ "icon": "🏠", "name": "勇者之家",  "clr": Color(0.3, 0.5, 0.3) },
	{ "icon": "🌿", "name": "草地",      "clr": Color(0.3, 0.6, 0.2) },
	{ "icon": "🌲", "name": "森林",      "clr": Color(0.1, 0.5, 0.1) },
	{ "icon": "⛰️", "name": "山地",      "clr": Color(0.4, 0.35, 0.25) },
	{ "icon": "🏜️", "name": "沙漠",      "clr": Color(0.7, 0.55, 0.2) },
	{ "icon": "❄️", "name": "雪地",      "clr": Color(0.7, 0.8, 0.9) },
	{ "icon": "💀", "name": "沼泽",      "clr": Color(0.2, 0.4, 0.1) },
	{ "icon": "🌋", "name": "火山",      "clr": Color(0.7, 0.2, 0.1) },
	{ "icon": "🏖️", "name": "海滩",      "clr": Color(0.9, 0.8, 0.4) },
	{ "icon": "🏘️", "name": "村庄",      "clr": Color(0.3, 0.5, 0.4) },
	{ "icon": "🏛️", "name": "神殿",      "clr": Color(0.9, 0.85, 0.5) },
	{ "icon": "⛏️", "name": "矿山",      "clr": Color(0.35, 0.3, 0.25) },
	{ "icon": "🌳", "name": "深林",      "clr": Color(0.05, 0.4, 0.05) },
	{ "icon": "🏚️", "name": "废墟",      "clr": Color(0.4, 0.35, 0.3) },
	{ "icon": "🧊", "name": "冰川",      "clr": Color(0.6, 0.8, 0.95) },
	{ "icon": "🔥", "name": "熔岩",      "clr": Color(0.8, 0.2, 0.05) },
...
func _build_top_bar() -> void:
	...
	lv_lbl.text = "Lv." + str(player_level) + "/100"
	...
	reward_lbl.text = "🎲 金币公式: min(Lv,100)×2.50"
...
func _generate_mock_map() -> void:
	...
	for i in range(1, map_total_grids):
		# 15种地块随机分布（索引0-15对应15种地形，16-25对应功能格）
		var gtype: int = 1 + (i % 15)
		map_grids.append(gtype)
